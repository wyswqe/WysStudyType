...
namespace Assets.Script.Utility.EventMgr
{
    public class EventManager : TSingleton<EventManager>
    {
        ...
        public void RemoveListener(EventDefineEnum eventID, TDelegate eventHandle)
        {
            int index = (int)eventID;
        ...
        public void AddListener<TParam>(EventDefineEnum eventID, TDelegate<TParam> eventHandle)
        {
            int index = (int)eventID;
            if (CheckValid(index, eventHandle))
            {
